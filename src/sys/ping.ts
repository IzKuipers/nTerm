...
class ConnectionChecker {
    ...
    stop() {
        ...
        userInterface.error(`Connection to dev server lost, unable to proceed.\n\nSystem halted. Press Ctrl+R to restart.\n`);
        userInterface.outputColor(`[Details: unable to fetch "${window.location.host}/__ping"]`,`var(--gray)`)
